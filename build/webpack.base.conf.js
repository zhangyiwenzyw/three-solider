...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: require.resolve("three/examples/js/controls/FirstPersonControls"),
        use: "imports-loader?THREE=three"
      },
      {
        test: require.resolve("three/examples/js/controls/FirstPersonControls"),
        use: "exports-loader?THREE.FirstPersonControls"
      },
      {
        test: require.resolve('three/examples/js/loaders/TGALoader'),
        use: 'imports-loader?THREE=three'
      },
      {
        test: require.resolve('three/examples/js/loaders/TGALoader'),
        use: 'exports-loader?THREE.TGALoader'
      },
      {
